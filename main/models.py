...
class Status_Contract(models.Model):
    """ Статус контракта """
...
class Reestr(models.Model):
    ...
    nc_contract = models.CharField(max_length=30, db_index=True, verbose_name='Номер карточки контракта',
                                   default='-')
    ...
    stat_contract = models.ForeignKey(Status_Contract, on_delete=models.DO_NOTHING, verbose_name='Статус', default='-')
